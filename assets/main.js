...
//   const parallaxElement = document.querySelector('.media-gallery.media-gallery--layout-carousel-under.media-gallery-size-medium.product-column-left.has-thumbnails');
  
//   // Only apply parallax effect if viewport is desktop size
//   function applyParallax() {
//     if (window.innerWidth >= 1024) { // Typical desktop breakpoint
//       window.addEventListener('scroll', handleScroll);
//     } else {
//       window.removeEventListener('scroll', handleScroll);
//       // Reset any transforms when not in desktop mode
